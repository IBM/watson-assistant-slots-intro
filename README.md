...
**NOTE:** Perform steps 1-5 **OR** click the ``Deploy to Bluemix`` button and hit ``Create`` and then jump to step 5. To run in a container on Bluemix, use [these instructions](doc/source/Container.md).
