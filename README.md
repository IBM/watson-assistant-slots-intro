...
# Creating a Pizza ordering Chatbot using Watson Assistant for Business Slots feature

In this Code Pattern, we will use the Watson Assistant for Business Slots feature to
build a chatbot that takes a pizza order. The needed information such as size, type,
and ingredient choices can all be entered within one Assistant for Business Node, unlike
with previous versions of Assistant for Business.

When the reader has completed this Code Pattern, they will understand how to:

* Create a chatbot dialog with Watson Assistant for Business
* Use the power of Assistant for Business Slots to more efficiently populate data fields
* Use Assistant for Business Slots to handle various inputs within one Node.
...
2. The application sends the user message to IBM Watson Assistant for Business service, and displays the ongoing chat in a web page.
3. Watson Assistant for Business uses the Slots feature to fill out the required fields for a pizza order, and sends requests for additional information back to the running application.
...
the Assistant for Business Intents, Entities, and Dialog Nodes.
...
# Assistant for Business Slots Discussion

The power of Slots is in how it reduces the number of nodes required to implement logic in your Watson Assistant for Business Dialog. Here's a partial conversation Dialog using the old method:
...
# Assistant for Business Example
...
"context" that is mostly used for Assistant for Business to keep track of internal state.
...
* [IBM Cloud Assistant for Business Docs](https://console.bluemix.net/docs/services/conversation/dialog-build.html#dialog-build)
* [Blog for Assistant for Business Slots Code Pattern](https://developer.ibm.com/code/2017/09/19/managing-resources-efficiently-watson-conversation-slots/)
